...
1.  Using R's base function "download.file" and the mode="libcurl" (for cross platform compatibility), the ZIP archive was downloaded to the "./data" directory. <https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip>
